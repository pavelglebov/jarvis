module.exports = {
  ...
  "rounds": [
    ...
    },
    {
      "output": [
        {
          "text": "Да, наверное у вас в команде этот человек, иначе вы бы не догадались",
          "timer": 0
        },
        {
    ...
    },
    {
      ...
      hints: ["чат нужно читать лучше... Впрочем еще не поздно найти что-то в чате"]
    },
    {
      output: [
        {
    ...
    },
    {
      output: [
        {
          text: "ЖЖ. Эта сладкая парочка поможет вам. Топайте к ней!",
          timer: 0,
        },
        {
