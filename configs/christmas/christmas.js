module.exports = {
  ...
  "rounds": [
    ...
    },
    {
      output: [
        {
          text: "Именно, вы наверное участвуете в спортивных ивентах?|она что и вас заставляет бегать?",
          timer: 0
        },
        {
    ...
    },
    {
      output: [
        {
          text: "Да, действительно так! Вы наверное участвовали, иначе не догадались бы",
          timer: 0,
        },
        {
